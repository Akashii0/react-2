    ...
    >
      ...
      <div className="flex flex-col items-center gap-8 z-20 pb-32 sm:pb-0">
        ...
        <div className="flex gap-4 font-inter">
          <button className="cursor-pointer py-3 px-10 bg-white rounded-2xl hover:bg-brand-gold hover:text-white">
            Shop now
          </button>
          <button className="cursor-pointer py-3 px-4 border-white border rounded-2xl text-white hover:border-brand-gold hover:text-brand-gold">
            New Collections
          </button>
        </div>
      </div>
