  ...
  return (
    <div className="fixed top-0 z-50 w-full py-6 px-10 md:px-24 bg-brand flex items-center justify-between">
      ...
      <div className="hidden sm:flex gap-16 font-inter text-[18px] text-white">
        <p className="hover:text-brand-gold cursor-pointer">Home</p>
        <p className="hover:text-brand-gold cursor-pointer">Shop</p>
        <p className="hover:text-brand-gold cursor-pointer">About</p>
        <p className="hover:text-brand-gold cursor-pointer">Blog</p>
        <p className="hover:text-brand-gold cursor-pointer">Contact</p>
      </div>
